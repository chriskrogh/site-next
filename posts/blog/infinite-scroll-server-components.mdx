...
<u>[Server components](https://react.dev/reference/rsc/server-components)</u>
are a great tool that allow us to render our UI closer to our data and send less
JS and JSON down to browsers.
